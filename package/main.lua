...
FALLBACK_FONT_10 = load_font_ref(APP_DIR .. "/font/clawd_cn_10.bin", FALLBACK_FONT_10)
FALLBACK_FONT_12 = load_font_ref(APP_DIR .. "/font/clawd_cn_12.bin", FALLBACK_FONT_12)
FALLBACK_FONT_14 = load_font_ref(APP_DIR .. "/font/clawd_cn_14.bin", FALLBACK_FONT_14)
FALLBACK_FONT_16 = load_font_ref(APP_DIR .. "/font/clawd_cn_14.bin", FALLBACK_FONT_16)
FALLBACK_FONT_28 = load_font_ref(APP_DIR .. "/font/clawd_cn_28.bin", FALLBACK_FONT_28)
...
-- Chinese UI uses LVGL bin fonts generated by lv_font_conv. Keep the old
-- Clawd Console rasterizer disabled so labels can render CJK glyphs natively.
local CONSOLE = nil
...
APP.web = HoloWeb.new({
  ...
  connection_state = function()
    ...
    return {
      ...
      font = {
        family = T("Clawd UI", "监控中文"),
        source = "lv_font_conv",
        rendering = T("LVGL grayscale", "LVGL 灰度"),
        loaded = true,
